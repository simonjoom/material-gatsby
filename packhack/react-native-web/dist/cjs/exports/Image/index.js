...
function (_Component) {
  ...
  function Image(props, context) {
    ...
    _this.simUpd = function (prevProps) {
      var finalResizeMode = _this.props.resizeMode || _this.props.style.resizeMode || _ImageResizeMode.default.cover; // CSS filters
  ...
  _proto.render = function render() {
    ...
    var flatStyle = _extends({}, _StyleSheet.default.flatten(this.props.style));
...
var styles = _StyleSheet.default.create({
  ...
  image: _extends({}, _StyleSheet.default.absoluteFillObject, {
  ...
  accessibilityImage: _extends({}, _StyleSheet.default.absoluteFillObject, {
    height: '100%',
    opacity: 0,
    width: '100%',
    zIndex: -1
